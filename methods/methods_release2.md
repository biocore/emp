...
`1907_EMPv2_INN_GNPS_quant.csv`: the feature table generated by MZmine that contains the ion intensity (LC-MS peak area) accross the EMP samples. This feature table is unprocessed table (no normalization or other post processing was applied to it).
...
Spectral library matching was performed against public spectral library and NIST17 to obtain putative level 2 annotation based on [MSI standards](https://pubs.acs.org/doi/abs/10.1021/es5002105). The job, paramaters and results can be consulted at the following address: [https://gnps.ucsd.edu/ProteoSAFe/status.jsp?task=d9c4449a61d645fca21ef3761e75a058](https://gnps.ucsd.edu/ProteoSAFe/status.jsp?task=d9c4449a61d645fca21ef3761e75a058). The search was also performed in analogue mode: [https://gnps.ucsd.edu/ProteoSAFe/status.jsp?task=effc2876c7644c709f08762bff7d422f](https://gnps.ucsd.edu/ProteoSAFe/status.jsp?task=effc2876c7644c709f08762bff7d422f). Citation: [(Wang et al., Nat. Biotech. 2016)](https://www.nature.com/articles/nbt.3597).
