...
# from qiime.parallel.util import get_random_job_prefix,\
#     write_jobs_file,submit_jobs, build_filepaths_from_filepaths, \
...
from emp_isme14.parallel_merge_otu_tables import start_job, local_job, torque_job, \
...
script_info['script_usage'].append(("""Example""","""Merge the OTU tables $PWD/t1.biom,$PWD/t2.biom,$PWD/t3.biom,$PWD/t4.biom,$PWD/t5.biom,$PWD/t6.biom and write the resulting output table to the $PWD/merged_table/ directory. ALWAYS SPECIFY ABSOLUTE FILE PATHS (absolute path represented here as $PWD, but will generally look something like /home/ubuntu/my_analysis/).""","""%prog -i $PWD/t1.biom,$PWD/t2.biom,$PWD/t3.biom,$PWD/t4.biom,$PWD/t5.biom,$PWD/t6.biom -o $PWD/merged_table/"""))
...
#############
## Begin code pulled from QIIME 1.5.0
#############
...
#############
## End code pulled from QIIME 1.5.0
#############
